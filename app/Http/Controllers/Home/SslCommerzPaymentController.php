...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $billingAddress = DB::table('billing_addresses')
            ...
            ->first();
        $post_data = array();
        $post_data['total_amount'] = substr($totalAmount * 84, 0, -2); # You cant not pay less than 10
        $post_data['currency'] = "BDT";
        $post_data['tran_id'] = uniqid(); // tran_id must be unique

        # CUSTOMER INFORMATION
        $post_data['cus_name'] = $billingAddress->first_name . '' . $billingAddress->last_name;
        $post_data['cus_email'] = $billingAddress->email;
        $post_data['cus_add1'] = $billingAddress->street_address . ',' . $billingAddress->city;
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
        $post_data['cus_country'] =  $billingAddress->country_name;
    ...
    public function success(Request $request)
    {
        ...
        $order_detials = DB::table('ssl_orders')
        ...
        return redirect(route('order-summary.index'));
    }
