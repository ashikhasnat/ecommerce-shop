    ...
    <div class=" flex flex-col">
        ...
        <form action="{{ route('shipping.store') }}" method="post">
            ...
            <div class=" mb-3">
                ...
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text" name="first_name">
            </div>
            <div class=" mb-3">
                <label for="last_name">Last Name<span class=" text-red-500">*</span></label>
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text" name="last_name">
            </div>
            <div class="mb-3">
                <label for="company_name">Company Name (optional)</label>
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text" name="company_name">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input value="" class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text"
                    name="street_address" placeholder="House Number and Street Number">
            </div>
            <div class="mb-3">
                <label for="city">Town / City <span class=" text-red-500">*</span></label>
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text" name="city">
            </div>
            <div class="mb-3">
                <label for="post_code">Postcode / ZIP <span class=" text-red-500">*</span></label>
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text" name="post_code">
            </div>
            <div class="mb-3">
                <label for="phone">Phone <span class=" text-red-500">*</span></label>
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text" name="phone">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class=" focus:outline-none py-2 mt-2 px-5 bg-gray-800 text-white">Save
                Address</button>
        </form>
        @if ($errors->any())
