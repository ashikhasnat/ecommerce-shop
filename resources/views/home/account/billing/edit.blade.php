<x-account>
    <div class=" flex flex-col">
        ...
        <form action="{{ route('billing.update', $billingAddress->id ) }}" method="post">
            @csrf
            @method('PATCH')
            <div class=" mb-3">
                ...
                <input class=" w-full border focus:outline-none py-1 px-3 mt-1" type="text"
                    value="{{ $billingAddress->first_name }}" name="first_name">
            </div>
            <div class=" mb-3">
                <label for="last_name">Last Name<span class=" text-red-500">*</span></label>
                <input value="{{ $billingAddress->last_name }}" class=" w-full border focus:outline-none py-1 px-3 mt-1"
                    type="text" name="last_name">
            </div>
            <div class="mb-3">
                <label for="company_name">Company Name (optional)</label>
                <input value="{{ $billingAddress->company_name ?? '' }}"
            ...
            <div class="mb-3">
                ...
                <input value="{{ $billingAddress->street_address}}"
            ...
            <div class="mb-3">
                ...
                <input value="{{ $billingAddress->city }}" class=" w-full border focus:outline-none py-1 px-3 mt-1"
                    type="text" name="city">
            </div>
            <div class="mb-3">
                <label for="post_code">Postcode / ZIP <span class=" text-red-500">*</span></label>
                <input value="{{ $billingAddress->post_code }}" class=" w-full border focus:outline-none py-1 px-3 mt-1"
                    type="text" name="post_code">
            </div>
            <div class="mb-3">
                <label for="phone">Phone <span class=" text-red-500">*</span></label>
                <input value="{{ $billingAddress->phone }}" class=" w-full border focus:outline-none py-1 px-3 mt-1"
