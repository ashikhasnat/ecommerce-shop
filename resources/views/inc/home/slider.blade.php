        ...
        <div slot="slide" class="slide bg-white home-slide">
            <section class="w-full h-full relative bg-no-repeat bg-center bg-cover"
                ...
                <div class=" flex flex-col justify-center h-full w-full ml-4 sm:ml-20">
                    ...
                    <a href="{{ $product->custom_product_link }}" target="_blank" class=" text-sm uppercase py-2 px-4 mt-6 border w-max-content text-white hover:border-teal-400
                    hover:bg-teal-400 transition-colors duration-300 ease-linear">shop
                        now</a>
                </div>
            </section>
        </div>
